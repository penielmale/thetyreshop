...
const featuredProducts = [
  { id: 9, name: 'Performance Brake Upgrade', tag: 'Best Seller', onSale: true },
  { id: 10, name: '4x4 Suspension Kit', tag: 'New Arrival', onSale: true },
  { id: 11, name: 'Long-Life Battery Pack', tag: 'Hot Deal', onSale: true },
]
          ...
          <div className="featured-grid">
            {featuredProducts.map((item) => (
              <article className="featured-card" key={item.id}>
                ...
                <strong className="featured-price">Request a quote</strong>
                <h3>{item.name}</h3>
