...
const products = [
  { id: 1, brand: 'Continental', name: 'Conti 4x4 Sport Contact', category: 'SUV & 4x4', size: '265/65 R17', price: 699, rating: 4.8, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/4x4-sport.jpg' },
  { id: 2, brand: 'Continental', name: 'Conti Premium Contact 5', category: 'Premium', size: '225/45 R17', price: 699, rating: 4.9, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/premium-contact.jpg' },
  { id: 3, brand: 'Continental', name: 'Conti Sport Contact 2', category: 'Touring', size: '205/55 R16', price: 699, rating: 4.8, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/sport-contact.jpg' },
  { id: 4, brand: 'Continental', name: 'Cross Contact LX 2', category: 'SUV & 4x4', size: '265/60 R18', price: 699, rating: 4.7, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/cross-contact.jpg' },
  { id: 5, brand: 'Dunlop', name: 'Grandtrek AT22', category: 'SUV & 4x4', size: '245/70 R16', price: 699, rating: 4.7, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/grand-trek-at22-1.jpg' },
  { id: 6, brand: 'Dunlop', name: 'SP Sport 560', category: 'Touring', size: '215/55 R17', price: 699, rating: 4.8, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/sp-sport-560-1.jpg' },
  { id: 7, brand: 'General Tire', name: 'Altimax Comfort', category: 'Premium', size: '205/55 R16', price: 699, rating: 4.6, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/altimax-comfort.jpg' },
  { id: 8, brand: 'General Tire', name: 'Grabber AT3', category: 'SUV & 4x4', size: '265/65 R17', price: 699, rating: 4.8, image: 'https://tyrezone.co.za/wp-content/uploads/2019/07/grabber-at-3.jpg' },
  { id: 9, brand: 'Performance', name: 'Suspension Shocks', category: 'Suspension', size: 'Universal', price: 699, rating: 4.7, image: shocksImg, tag: 'Best Seller' },
  { id: 10, brand: 'Premium', name: 'Alloy Wheels', category: 'Wheels', size: '18 inch', price: 699, rating: 4.9, image: wheelsImg, tag: 'New Arrival' },
  { id: 11, brand: 'Performance', name: 'Exhaust Systems', category: 'Exhaust', size: 'Performance', price: 699, rating: 4.8, image: exhaustsImg, tag: 'Hot Deal' },
  { id: 12, brand: 'Durable', name: 'CV Joints', category: 'Drive Train', size: 'OEM', price: 699, rating: 4.6, image: cvJointsImg },
  { id: 13, brand: 'Platinum', name: 'Car Battery', category: 'Battery', size: '60Ah', price: 699, rating: 4.9, image: batteriesImg },
  { id: 14, brand: 'Brembo', name: 'Brake System', category: 'Brakes', size: 'Performance', price: 699, rating: 4.8, image: brakesImg },
  { id: 15, brand: 'Tow-Max', name: 'Tow Bars', category: 'Towing', size: 'Fixed', price: 699, rating: 4.7, image: towbarsImg },
]

const featuredProducts = [
  { id: 9, name: 'Performance Brake Upgrade', price: 5499, tag: 'Best Seller', onSale: true },
  { id: 10, name: '4x4 Suspension Kit', price: 8899, tag: 'New Arrival', onSale: true },
  { id: 11, name: 'Long-Life Battery Pack', price: 2699, tag: 'Hot Deal', onSale: true },
]
    ...
    <>
      ...
      <main id="top">
            ...
            {featuredProducts.map((item) => (
              <article className="featured-card" key={item.id}>
                <div className="featured-tags">
                  {item.onSale && <span className="featured-on-sale">On Sale</span>}
                  <span className="featured-tag">{item.tag}</span>
                </div>
                <strong className="featured-price">From R{item.price.toLocaleString()}</strong>
                <h3>{item.name}</h3>
        ...
        <section className="finder" id="shop">
          ...
          <div className="product-grid">{filtered.map((product) => <article className="product-card" key={product.id}><div className="product-image">{product.tag && <span className="product-tag">{product.tag}</span>}<img src={product.image} alt={`${product.brand} ${product.name}`} /><span>{product.category}</span></div><div className="product-content"><div className="product-brand">{product.brand}<span>★ {product.rating}</span></div><h3>{product.name}</h3><p>{product.size} · {product.category}</p><div className="product-footer"><strong><span className="on-sale-badge">On Sale</span> R{product.price.toLocaleString()}</strong><button aria-label={`Add ${product.name} to quote`} onClick={() => { setQuoteOpen(true); notify(`${product.name} added to your quote`) }}>+</button></div></div></article>)}</div>
        </section>
